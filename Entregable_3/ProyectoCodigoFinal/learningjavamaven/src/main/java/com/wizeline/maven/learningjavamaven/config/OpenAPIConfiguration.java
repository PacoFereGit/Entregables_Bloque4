...
@OpenAPIDefinition(
        info = @Info(title = "${info.app.name}", version = "${info.app.java.version}",
                contact = @Contact(name = "Developer", email = "fferegrino@wizeline.com",
                        url = "https://www.wizeline.com/")),
        servers = {
                @Server(url = "http://localhost:8080", description = "Entorno de desarrollo."),
                @Server(url = "http://produccion:5443", description = "Entorno productivo"),
...
public class OpenAPIConfiguration {
    ...
    }//fin del metodo customizeOpenAPI

}//fin de la clase OpenAPIConfiguration
